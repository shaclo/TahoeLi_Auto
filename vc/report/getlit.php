...
class getlit{
    ...
    public function getlitbrand($d1,$d2){
        ...
        $query = "select distinct b.brand from users b
where b.contract not in (select DISTINCT contract from daliyamt where txdate between '$d1' and '$d2') ";
		//echo $query;
